...
<div class="login-page">
  <div class="login-card">
    <div class="login-header">
      ...
      <p class="login-subtitle">Organise tes idees, partout.</p>
    </div>

    <button type="button" class="btn-google" @click="handleLogin" :disabled="isLoading">
...
async function handleLogin() {
  ...
  try {
    ...
    if (e.code === 'auth/popup-closed-by-user') {
      ...
      error.value = 'Erreur de connexion. Reessaie.'
